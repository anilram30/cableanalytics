...
[private vulnerability reporting](https://github.com/anilram30/cableanalytics/security/advisories/new), or email sreeramanil30@gmail.com.

Expect an acknowledgement within a week.

## Scope and threat model

`cableanalytics` reads measurement data files, configuration files and, in some packages, instrument
